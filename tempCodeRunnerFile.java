...
public class BSTVisualization extends JFrame implements ActionListener, KeyListener {
	...
	private static class Node {
		...
		Node(int info) {
			...
			data.setOpaque(true);
			data.setBackground(new Color(173, 216, 230)); // Light Blue
			p = null;
		}
	}
	...
	private void initialize() {
		...
		treePanel.setBackground(new Color(240, 248, 255)); // Alice Blue
		...
		labelHeight.setForeground(new Color(25, 25, 112)); // Midnight Blue
		...
		ansHeight.setForeground(new Color(25, 25, 112)); // Midnight Blue
		...
		btnDelete.setBackground(new Color(173, 216, 230)); // Light Blue
		...
		labelInorder.setForeground(new Color(25, 25, 112)); // Midnight Blue
		labelInorder.setAlignmentX(Component.CENTER_ALIGNMENT);
		...
		ansInorder.setForeground(new Color(25, 25, 112)); // Midnight Blue
		ansInorder.setAlignmentX(Component.CENTER_ALIGNMENT);
		...
		labelPreorder.setForeground(new Color(25, 25, 112)); // Midnight Blue
		labelPreorder.setAlignmentX(Component.CENTER_ALIGNMENT);
		...
		ansPreorder.setForeground(new Color(25, 25, 112)); // Midnight Blue
		ansPreorder.setAlignmentX(Component.CENTER_ALIGNMENT);
		...
		labelPostorder.setForeground(new Color(25, 25, 112)); // Midnight Blue
		labelPostorder.setAlignmentX(Component.CENTER_ALIGNMENT);
		...
		ansPostorder.setForeground(new Color(25, 25, 112)); // Midnight Blue
		ansPostorder.setAlignmentX(Component.CENTER_ALIGNMENT);
